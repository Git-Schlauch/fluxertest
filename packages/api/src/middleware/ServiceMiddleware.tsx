...
import {IPTVService} from '@fluxer/api/src/channel/services/IPTVService';
...
export const ServiceMiddleware = createMiddleware<HonoEnv>(async (ctx, next) => {
	...
	const iptvService = new IPTVService(channelRepository, gatewayService, liveKitService, voiceRoomStore, kvClient);
	...
	ctx.set('iptvService', iptvService);
