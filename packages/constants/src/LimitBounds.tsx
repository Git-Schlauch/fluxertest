...
export const LIMIT_KEY_BOUNDS: Record<LimitKey, {min: number; max: number}> = {
	...
	max_guild_emojis_animated_more: {min: 0, max: 5000},
	max_guild_emojis_animated: {min: 0, max: 5000},
	max_guild_emojis_static_more: {min: 0, max: 5000},
	max_guild_emojis_static: {min: 0, max: 5000},
