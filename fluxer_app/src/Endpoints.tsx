...
export const Endpoints = {
	...
	CHANNEL_IPTV: (channelId: string) => `/channels/${channelId}/iptv`,
	CHANNEL_IPTV_START_DIRECT: (channelId: string) => `/channels/${channelId}/iptv/start-direct`,
	CHANNEL_IPTV_START: (channelId: string) => `/channels/${channelId}/iptv/start`,
	CHANNEL_IPTV_START_FROM_CONFIG: (channelId: string) => `/channels/${channelId}/iptv/start-from-config`,
	CHANNEL_IPTV_STOP: (channelId: string) => `/channels/${channelId}/iptv/stop`,
	CHANNEL_IPTV_PLAYLIST_CONFIG: (channelId: string) => `/channels/${channelId}/iptv/playlist-config`,
	CHANNEL_IPTV_PLAYLIST_CONFIG_UPLOAD: (channelId: string) => `/channels/${channelId}/iptv/playlist-config/upload`,
	CHANNEL_IPTV_CHANNELS: (channelId: string) => `/channels/${channelId}/iptv/channels`,
