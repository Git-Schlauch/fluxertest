...
type VoiceSettingsUpdate = Partial<{
	...
	voiceRoomChatMessageLimit: number;
	voiceRoomChatMessageTtlMinutes: number;
}>;
...
class VoiceSettingsStore {
	...
	voiceRoomChatMessageLimit = 120;
	voiceRoomChatMessageTtlMinutes = 180;
	...
	constructor() {
		makeAutoObservable(
			this,
			{
				...
				getVoiceRoomChatMessageLimit: false,
				getVoiceRoomChatMessageTtlMinutes: false,
			},
			{autoBind: true},
		);
	...
	getVoiceRoomChatMessageLimit(): number {
		return this.voiceRoomChatMessageLimit;
	}

	getVoiceRoomChatMessageTtlMinutes(): number {
		return this.voiceRoomChatMessageTtlMinutes;
	}
	...
	updateSettings(data: VoiceSettingsUpdate): void {
		...
		if (validated.voiceRoomChatMessageLimit !== undefined)
			this.voiceRoomChatMessageLimit = validated.voiceRoomChatMessageLimit;
		if (validated.voiceRoomChatMessageTtlMinutes !== undefined)
			this.voiceRoomChatMessageTtlMinutes = validated.voiceRoomChatMessageTtlMinutes;
	}
	...
	private validateSettings(data: VoiceSettingsUpdate): VoiceSettingsUpdate {
		...
		return {
			...
			voiceRoomChatMessageLimit: Math.max(10, Math.min(500, data.voiceRoomChatMessageLimit ?? this.voiceRoomChatMessageLimit)),
			voiceRoomChatMessageTtlMinutes: Math.max(
				5,
				Math.min(1440, data.voiceRoomChatMessageTtlMinutes ?? this.voiceRoomChatMessageTtlMinutes),
			),
		};
	}
}
