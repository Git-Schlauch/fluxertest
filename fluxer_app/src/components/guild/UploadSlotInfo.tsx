...
interface UploadSlotInfoProps {
	...
	onUploadClick: () => void;
	secondaryUploadButtonText?: React.ReactNode;
	onSecondaryUploadClick?: () => void;
...
export const UploadSlotInfo: React.FC<UploadSlotInfoProps> = observer(
	({
		...
		const hasSecondaryButton = Boolean(secondaryUploadButtonText && onSecondaryUploadClick);
				...
				<div className={styles.header}>
					...
					<div className={styles.uploadButtonDesktop}>
						<div className={styles.uploadButtonGroup}>
							...
							{hasSecondaryButton && (
								<Button onClick={onSecondaryUploadClick} leftIcon={<UploadIcon className={styles.icon} />}>
									{secondaryUploadButtonText}
								</Button>
							)}
						</div>
